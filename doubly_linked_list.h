 ...
 * split
 *
 * Split the linked list at the Node provided as input
 * The original linked list should contain all the nodes from the head to Node, inclusive
 * The returned linked list should contain all the nodes from Node->next to the tail, inclusive
 * In the case where Node is the tail, simply return NULL.
 * 
 * @param dLinkedList A pointer to the doubly linked list
 * @param Node A pointer to the node at which the list should be split
 * 
 * @return a pointer to the 'second' linked list
 */
